...
var _default2 = {
  ...
  created: function created() {
    ...
    if (proxyConfig && (data || proxyOpts.form && formOpts.data)) {
      _tools.UtilTools.error('vxe.error.errConflicts', ['grid.data', 'grid.proxy-config']);
    }
        ...
        case 'query':
          {
            ...
            if (ajaxMethods) {
              ...
              if (process.env.NODE_ENV === 'development') {
                _tools.UtilTools.error('vxe.error.notFunc', ['proxy-config.ajax.query']);
              }
            }
        ...
        case 'delete':
          {
            ...
            if (_ajaxMethods) {
                    ...
                    if (isMsg) {
                      ...
                      if (process.env.NODE_ENV === 'development') {
                        if (!_vXETable.default.modal) {
                          _tools.UtilTools.error('vxe.error.reqModule', ['Modal']);
                        }
                      }
              ...
              if (process.env.NODE_ENV === 'development') {
                _tools.UtilTools.error('vxe.error.notFunc', ['proxy-config.ajax.delete']);
              }
            }
        ...
        case 'save':
          {
            ...
            if (_ajaxMethods2) {
              ...
              if (process.env.NODE_ENV === 'development') {
                _tools.UtilTools.error('vxe.error.notFunc', ['proxy-config.ajax.save']);
              }
            }
