...
function syncBodyScroll(_vm, fixedType, scrollTop, elem1, elem2) {
  if (elem1 || elem2) {
    ...
    scrollProcessTimeout = setTimeout(function () {
      var _vm$$refs = _vm.$refs,
          tableBody = _vm$$refs.tableBody,
          leftBody = _vm$$refs.leftBody,
          rightBody = _vm$$refs.rightBody;
      ...
      var targetLeft = bodyElem.scrollLeft;
      ...
      (0, _dom.setScrollLeftAndTop)(bodyElem, targetLeft, targetTop);
      (0, _dom.setScrollLeftAndTop)(leftElem, targetLeft, targetTop);
      (0, _dom.setScrollLeftAndTop)(rightElem, targetLeft, targetTop);
    }, 300);
  }
}
