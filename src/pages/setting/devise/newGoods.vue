      ...
      <div class="acea-row row-top">
        <div class="left" :style="colorStyle">
          ...
          >
            ...
            <div class="store" :class="!optionstList.is_sku && !optionstList.is_specs && !optionstList.is_ensure?'on':''" v-show="optionstList.is_store">
              <div class="store-up acea-row row-middle">
                ...
                <img
                  ...
                  class="img"
                />
                <span class="store-name">陕西西安西咸广场小米之家</span>
                <span class="iconfont iconjinru"></span>
              </div>
              <div class="nearby">
                <span class="nearby-name">距您5.4km</span>
                · 陕西省西安市未央区
              </div>
            </div>
          </div>
          ...
          <div v-if="current == 3">
            <div class="c_row-item">
              ...
              <Col span="20" class="slider-box">
                ...
                <Checkbox v-model="optionstList.is_store">门店</Checkbox>
              </Col>
            </div>
            <div class="c_row-item">
