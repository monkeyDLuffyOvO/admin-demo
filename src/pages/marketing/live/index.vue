        ...
        <Card :bordered="false" dis-hover class="ivu-mt">
            ...
            <Table :columns="columns1" :data="tabList" ref="table" class="ivu-mt"
                ...
                <template slot-scope="{ row, index }" slot="status">
                    <Tag color="default" size="large" v-show="row.status === 0">{{row.live_status | liveReviewStatusFilter}}</Tag>
                    <Tag color="orange" size="large" v-show="row.status === 1">{{row.live_status | liveReviewStatusFilter}}</Tag>
                    <Tag color="green" size="large" v-show="row.status === 2">{{row.live_status | liveReviewStatusFilter}}</Tag>
                    <Tag color="default" size="large" v-show="row.status === 3">{{row.live_status | liveReviewStatusFilter}}</Tag>
                </template>
