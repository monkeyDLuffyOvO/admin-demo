<template>
    <div class="wrapper-box">
        ...
        <!-- <div class="foot-box" v-else>Copyright © 2023 | <a class="infoUrl" href="https://www.higoshp.net" target="_blank">深圳蚁企邦科技有限公司 {{version}} 客服系统</a></div> -->
        <div class="foot-box" v-else>Copyright © 2023 | <a class="infoUrl" href="https://www.higoshp.net" target="_blank">HIGOSHOP助力中小微企业数字化运营</a></div>
    </div>
</template>
<script>
