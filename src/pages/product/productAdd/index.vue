        ...
        <Row :gutter="24" type="flex" v-show="currentTab === '1'">
		  ...
		  <Col span="24">
		    <FormItem label="商品分类：" prop="cate_id">
									...
									<span class="addClass" @click="addClass" v-if="merchantType===0">新增分类</span>
					  ...
					  <FormItem label="商品品牌：" prop="">
							<Cascader
							   ...
							   filterable
								 v-width="'50%'"
							></Cascader>
							<span class="addClass" @click="addBrand" v-if="merchantType===0">新增品牌</span>
					  </FormItem>
					</Col>
          <Col span="24">
            <FormItem label="单位：" prop="unit_name">
				...
				<span class="addClass" @click="addUnit" v-if="merchantType===0">新增单位</span>
            </FormItem>
          </Col>
		<!--  <Col span="24">
					...
					<Col span="24">
						<FormItem label="商品标签：" prop="store_label_id" class="labelClass">
							<div class="acea-row row-middle">
								...
								<span class="addClass" @click="addStoreLabel">新增标签{{formValidate.supplier_id}}pp</span>
							</div>
						</FormItem>
					</Col>
				      <Col span="24">
            <FormItem label="供应商：" prop="supplier_id" v-if="formValidate.product_type == 0 && merchantType===0">
				<Select
			...
			<Col v-bind="grid3">
			  <FormItem label="配送方式：" prop="" required>
			    <CheckboxGroup v-model="formValidate.delivery_type">
			      <Checkbox label="1" v-if="merchantType===0">快递</Checkbox>
