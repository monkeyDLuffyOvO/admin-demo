...
<!-- 登录 -->
    <div class="page-account">
      ...
      <div class="footer">
        ...
        <!-- <div class="pull-right" v-else>Copyright ©2020-2023 <a class="infoUrl" href="https://www.higoshop.net" target="_blank">| HIGOSHOP助力中小微企业数字化运营 {{version}}</a></div> -->
        <div class="pull-right" v-else>Copyright ©2012-2025 <a class="infoUrl" href="https://www.higoshop.net" target="_blank">| HIGOSHOP助力企业数字化运营</a></div>
      </div>
